...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_FISTS );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_FISTS );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_FISTS );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_FISTS );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_FISTS );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_FISTS2 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_FISTS );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_FISTS );
}
