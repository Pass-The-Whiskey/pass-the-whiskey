...
#define TFWorkshopMsg(...) Msg("[Workshop] " __VA_ARGS__)
#define TFWorkshopWarning(...) Warning("[Workshop] " __VA_ARGS__)

#ifdef TF_WORKSHOP_DEBUG
#define TFWorkshopDebug(...) DevMsg("[Workshop Debug] " __VA_ARGS__)
...
public:
	...
	bool GetLocalPath( /* out */ CUtlString &strLocalPath );
