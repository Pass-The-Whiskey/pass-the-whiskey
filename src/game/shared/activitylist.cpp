...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY( ACT_MP_CYOA_PDA_OUTRO );
  	...
  	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_FISTS );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_FISTS );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_FISTS );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_FISTS );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_FISTS );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_FISTS2 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_FISTS );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_FISTS );
