...
const char *g_ppszPlayerSoundSuffixNames[PLAYER_SOUNDS_MAX] =
{
	"",
	"_p2",
	"_p3",
...
const char *CHL2MP_Player::GetPlayerModelSoundSuffix( void )
{
	return g_ppszPlayerSoundSuffixNames[m_iPlayerSoundType];
}
